...
public class Display extends JFrame {
    ...
    //Header Part
    JTextField nameField, sectionField, averageField;

    //Grading Part
    JTextField myGrade1, myGrade2, myGrade3, myGrade4, myGrade5, myGrade6, myGrade7;
    ...
    public void addDisplayInterface() {
        ...
        nameField = getTextField(180,36, 250,20);
        JLabel sectionLabel = getLabel("Section: ", 70, 70, 0, 22);  
        sectionField = getTextField(180,76,250,20);
        JLabel averageLabel = getLabel("Average: ", 70, 110, 0, 22);
        averageField = getTextField(180,118,250,20);
        ...
        myGrade1 = getTextField(380,180, 50, 25);
        ...
        myGrade2 = getTextField(380,240, 50, 25);
        ...
        myGrade3 = getTextField(380,300, 50, 25);
        ...
        myGrade4 = getTextField(380,360, 50, 25);
        ...
        myGrade5 = getTextField(380,420, 50, 25);
        ...
        myGrade6 = getTextField(380,480, 50, 25);
        ...
        myGrade7 = getTextField(380,540, 50, 25);

        JButton myButton1 = getSelection("Average", 70,620);
        JButton myButton2 = getSelection("Revert", 285,620);
        
        Calculation calc = new Calculation(new JTextField[]
        { nameField, sectionField, averageField },
        myGrade1, myGrade2, myGrade3,
        myGrade4, myGrade5, myGrade6, myGrade7
        );

        myButton1.addActionListener(calc);
        myButton2.addActionListener(calc);

        this.add(myButton1);        this.add(myButton2);        this.add(averageLabel);     this.add(averageField);
